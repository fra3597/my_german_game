class ParadigmScore:
    def __init__(self):
        ...
        self.present_partial_counter: int = 0
        self.praeteritum_partial_counter: int = 0
        self.perfekt_partial_counter: int = 0

        self.present_total_counter: int = 0
        self.praeteritum_total_counter: int = 0
        self.perfekt_total_counter: int = 0

        self.present_partial_score: int = 0
        self.praeteritum_partial_score: int = 0
        self.perfekt_partial_score: int = 0

        self.present_total_score: int = 0
        self.praeteritum_total_score: int = 0
        self.perfekt_total_score: int = 0
